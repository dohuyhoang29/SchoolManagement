...
public class TeacherController {
	...
	public String listTeacherByPage(Model model, @PathVariable("page") int currentPage,
		...
		List<TeacherManagementRequest> list = page.getContent().stream()
				.map(user -> modelMapper.map(user, TeacherManagementRequest.class)).collect(Collectors.toList());
	...
	public String updateTeacher(@Valid @ModelAttribute("user") EditTeacherRequest user, BindingResult result,
